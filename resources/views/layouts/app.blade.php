...
<body>
    <header>
        ...
        <nav><a href="{{ route('home') }}#services">Services</a><a href="{{ route('it-solutions') }}">IT Solutions</a><a href="{{ route('products.index') }}">Gift catalogue</a><a href="{{ route('home') }}#ai">AI concierge</a><a href="{{ route('home') }}#contact">Contact</a></nav>
    ...
    <footer>
        ...
        <div><b>Services</b><a href="{{ route('products.index') }}">Corporate gifts</a><a href="{{ route('home') }}#events">Event management</a><a href="{{ route('it-solutions') }}">IT solutions</a></div>
